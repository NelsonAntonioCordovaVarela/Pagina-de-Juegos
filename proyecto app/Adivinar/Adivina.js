...
let arrayPalabras =["GUITARRA", "ADIDAS", "NEGRO", "SAMSUNG", "ABRIGO", "ECUADOR"];
...
let ayudas = [
    ...
    "Es un color",
    "Marca de Celular",
    "Ropa que se usa cuando hace frio",
    "Es un Pais"
]
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["GUITARRA", "ADIDAS", "NEGRO", "SAMSUNG", "ABRIGO", "ECUADOR"];
        ayudas = [
            "Instrumento Musical",
            "Marca de zapatos",
            "Es un color",
